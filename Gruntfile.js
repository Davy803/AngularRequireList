    ...
    grunt.initConfig({
            ...
            scripts: {
                files: [{
                    ...
                    src: (grunt.option('maps') || grunt.option('no-dev'))
                       ? ['app/config.js', 'app/vendor/requirejs/require.js']
        ...
        bower: {
            main: {
                ...
                rjsConfig: '<%= env.DIR_SRC %>/app/config.js'
            }
        },
        ...
        watch: {
            ...
            scripts: {
                files: ['<%= env.DIR_SRC %>/assets/{scripts,vendor}/**/*.js', '<%= env.DIR_SRC %>/app/**/*.js'],
                tasks: ['scripts']
            }
        }
    });
